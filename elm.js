...
{
	if (region.aq.J === region.aC.J)
	{
		return 'on line ' + region.aq.J;
	}
	return 'on lines ' + region.aq.J + ' through ' + region.aC.J;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bB: 'hidden', bi: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bB: 'mozHidden', bi: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bB: 'msHidden', bi: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bB: 'webkitHidden', bi: 'webkitvisibilitychange' }
		: { bB: 'hidden', bi: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aE: fragment, aH: host, aU: path, aW: port_, aZ: protocol, a_: query};
	});
...
var $author$project$Main$InitColor = function (a) {
	return {$: 0, a: a};
};
...
var $tesk9$palette$Internal$HSLA$fromChannels = function (_v0) {
	var hue = _v0.aI;
	var saturation = _v0.a3;
	var lightness = _v0.W;
	var alpha = _v0.af;
	...
	return {
		af: alpha,
		aI: hue360 + floatingHueValues,
		W: A3($elm$core$Basics$clamp, 0, 100, lightness),
		a3: A3($elm$core$Basics$clamp, 0, 100, saturation)
	};
};
...
var $tesk9$palette$Color$fromHSL = function (_v0) {
	var hue = _v0.a;
	var saturation = _v0.b;
	var lightness = _v0.c;
	return $tesk9$palette$Internal$Color$fromHSLA(
		{af: $tesk9$palette$Internal$Opacity$opaque, aI: hue, W: lightness, a3: saturation});
};
var $author$project$Rgb$fromHSL = F3(
	function (h, s, l) {
		return $tesk9$palette$Color$fromHSL(
			_Utils_Tuple3(h, s, l));
	});
var $author$project$Rgb$initColor = A3($author$project$Rgb$fromHSL, 0, 0, 50);
...
var $author$project$Rgb$randomColor = A4(
	$elm$random$Random$map3,
	$author$project$Rgb$fromHSL,
	A2($elm$random$Random$float, 0, 359),
	A2($elm$random$Random$float, 0, 100),
	$elm$random$Random$constant(50.0));
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{y: $author$project$Rgb$initColor, V: flags.V, W: 50, ae: flags.ae, Q: 0, R: 0},
		A2($elm$random$Random$generate, $author$project$Main$InitColor, $author$project$Rgb$randomColor));
};
...
var $author$project$Rgb$calculateColor = function (_v0) {
	var x = _v0.Q;
	var y = _v0.R;
	var width = _v0.ae;
	var height = _v0.V;
	var lightness = _v0.W;
	return A3($author$project$Rgb$fromHSL, (x / width) * 360, 100 - ((y / height) * 100), lightness);
};
...
var $tesk9$palette$Internal$RGBA$fromChannels = function (_v0) {
	...
	return {
		af: alpha,
		S: A3($elm$core$Basics$clamp, 0, 255, blue),
		U: A3($elm$core$Basics$clamp, 0, 255, green),
		ac: A3($elm$core$Basics$clamp, 0, 255, red)
	};
};
var $tesk9$palette$Internal$RGBA$fromHSLA = function (hsl) {
	var hue = hsl.aI;
	var alpha = hsl.af;
	var saturation = hsl.a3 / 100;
	var lightness = hsl.W / 100;
	var hueIsBetween = F2(
	...
	return $tesk9$palette$Internal$RGBA$fromChannels(
		{af: alpha, S: (b + lightnessModifier) * 255, U: (g + lightnessModifier) * 255, ac: (r + lightnessModifier) * 255});
};
...
var $tesk9$palette$Internal$Hex$getHexSymbol = function (m) {
...
var $tesk9$palette$Internal$Hex$decToHex = function (c) {
	var nextValue = function (_v0) {
		nextValue:
		while (true) {
			var dec = _v0.a;
			var hex = _v0.b;
			if (!dec) {
				...
				var $temp$_v0 = _Utils_Tuple2(
					(dec / 16) | 0,
					_Utils_ap(
						$tesk9$palette$Internal$Hex$getHexSymbol(dec % 16),
						hex));
				_v0 = $temp$_v0;
				continue nextValue;
			}
...
var $tesk9$palette$Internal$Hex$toStringWithOpacity = function (_v0) {
	var red = _v0.ac;
	var green = _v0.U;
	var blue = _v0.S;
	var alpha = _v0.af;
	var opacityInDec = $tesk9$palette$Internal$Hex$decToHex(
		$tesk9$palette$Internal$Opacity$toFloat(alpha) * 255);
	return '#' + ($tesk9$palette$Internal$Hex$decToHex(red) + ($tesk9$palette$Internal$Hex$decToHex(green) + ($tesk9$palette$Internal$Hex$decToHex(blue) + opacityInDec)));
};
var $tesk9$palette$Internal$Hex$toStringWithoutOpacity = function (_v0) {
	var red = _v0.ac;
	var green = _v0.U;
	var blue = _v0.S;
	return '#' + ($tesk9$palette$Internal$Hex$decToHex(red) + ($tesk9$palette$Internal$Hex$decToHex(green) + $tesk9$palette$Internal$Hex$decToHex(blue)));
};
var $tesk9$palette$Internal$Hex$toString = function (values) {
	var alpha = values.af;
	return _Utils_eq($tesk9$palette$Internal$Opacity$opaque, alpha) ? $tesk9$palette$Internal$Hex$toStringWithoutOpacity(values) : $tesk9$palette$Internal$Hex$toStringWithOpacity(values);
};
var $tesk9$palette$Color$toHex = function (color) {
	var _v0 = $tesk9$palette$Color$toRGB(color);
	var red = _v0.a;
	var green = _v0.b;
	var blue = _v0.c;
	return $tesk9$palette$Internal$Hex$toString(
		{af: $tesk9$palette$Internal$Opacity$opaque, S: blue, U: green, ac: red});
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Main$updateColor = _Platform_outgoingPort('updateColor', $elm$json$Json$Encode$string);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						newModel,
						{
							y: $author$project$Rgb$calculateColor(newModel)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				var dy = msg.a;
				var l = A2(
					$elm$core$Basics$max,
					0,
					A2($elm$core$Basics$min, 100, model.W + (dy / 10)));
				var newModel = _Utils_update(
					model,
					{W: l});
				return _Utils_Tuple2(
			...
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Main$updateColor(
						$tesk9$palette$Color$toHex(model.y)));
		}
	});
var $author$project$Main$SelectColor = {$: 3};
var $author$project$Main$UpdateLightness = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$mouseCoordinates = function (ev) {
	var _v0 = ev.ay;
	var x = _v0.a;
	var y = _v0.b;
	return A2($author$project$Main$Position, x, y);
};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Touch$defaultOptions = {an: true, ar: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Touch$Event = F4(
	function (keys, changedTouches, targetTouches, touches) {
		return {bj: changedTouches, bG: keys, b7: targetTouches, cb: touches};
	});
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F3(
	function (alt, ctrl, shift) {
		return {bd: alt, bm: ctrl, b3: shift};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Touch$Touch = F4(
	function (identifier, clientPos, pagePos, screenPos) {
		return {ay: clientPos, bC: identifier, bX: pagePos, b2: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$defaultOptions = {an: true, ar: false};
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {bh: button, ay: clientPos, bG: keys, bS: offsetPos, bX: pagePos, b2: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Wheel$defaultOptions = {an: true, ar: false};
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Wheel$Event = F3(
	function (mouseEvent, deltaY, deltaMode) {
		return {bp: deltaMode, bq: deltaY, bI: mouseEvent};
	});
...
var $author$project$Main$touchCoordinates = function (touchEvent) {
	var _v0 = A2(
		...
		A2(
			...
			$elm$core$List$head(touchEvent.bj)));
	var x = _v0.a;
	var y = _v0.b;
	return A2($author$project$Main$Position, x, y);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$Basics$composeL, $author$project$Main$UpdatePosition, $author$project$Main$mouseCoordinates)),
				$mpizenberg$elm_pointer_events$Html$Events$Extra$Touch$onMove(
				A2($elm$core$Basics$composeL, $author$project$Main$UpdatePosition, $author$project$Main$touchCoordinates)),
				$mpizenberg$elm_pointer_events$Html$Events$Extra$Touch$onEnd(
				function (_v0) {
					return $author$project$Main$SelectColor;
				}),
				$mpizenberg$elm_pointer_events$Html$Events$Extra$Wheel$onWheel(
				function (ev) {
					return $author$project$Main$UpdateLightness(ev.bq);
				}),
				$elm$html$Html$Events$onClick($author$project$Main$SelectColor),
				A2(
				$elm$html$Html$Attributes$style,
				'backgroundColor',
				$tesk9$palette$Color$toRGBString(model.y))
			]),
		_List_Nil);
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{bE: $author$project$Main$init, b4: $author$project$Main$subscriptions, cc: $author$project$Main$update, cd: $author$project$Main$view});
